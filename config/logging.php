...
return [
    ...
    'channels' => [
        ...
        'stderr' => ['driver' => 'monolog', 'handler' => StreamHandler::class, 'with' => ['stream' => 'php://stderr'], 'level' => env('LOG_LEVEL', 'debug'), 'formatter' => env('LOG_STDERR_FORMATTER')],
        'syslog' => ['driver' => 'syslog', 'facility' => LOG_USER, 'level' => env('LOG_LEVEL', 'debug'), 'replace_placeholders' => true],
